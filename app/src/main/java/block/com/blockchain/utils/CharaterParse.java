...
//				}
    ...
    public HashMap<String, String> initDictionary(){
        ...
        try{
            inputReader = new InputStreamReader(MyApp.mContext.getResources().getAssets().open(fileName),"UTF-8");
